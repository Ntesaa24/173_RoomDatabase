package com.example.pertemuan9_pam.viewmodel
...
import com.example.pertemuan9_pam.repositori.RepositoriSiswa
...
class EditViewModel(
	...
	private val idSiswa: Int = checkNotNull(savedStateHandle[DestinasiDetaillSiswa.itemIdArg])
	init{
